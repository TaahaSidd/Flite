    ...
    return (
        <div className="w-screen min-h-screen bg-[#0C0C0C] flex flex-col justify-center items-center overflow-hidden relative font-mono selection:bg-[#FF6B00] selection:text-white">
            ...
            {onBack && (
                <button 
                    onClick={onBack}
                    className="absolute top-8 left-8 text-xs font-bold font-mono tracking-widest text-zinc-500 hover:text-zinc-300 border border-zinc-800 hover:border-zinc-700 px-4 py-2 rounded transition-all duration-300 bg-transparent uppercase"
                >
                    ← Back to Home
                </button>
            )}
